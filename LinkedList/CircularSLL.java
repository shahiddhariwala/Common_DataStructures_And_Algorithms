...
public class CircularSLL {
	...
	private void insert(int loc, int val) {
		...
		if(head==null)
		{
			...
			tail=node;
			last=0;
			System.out.print("Head Initialised as it was empty\n");
		}
		else if(loc==0)
		{
	...
	public static void main(String[] args) {
		...
		do
		{
			...
			System.out.println("1. Create Circular Single LinkedList");
